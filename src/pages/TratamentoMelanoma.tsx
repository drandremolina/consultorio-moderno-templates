              ...
              <Card className="card-medical mb-6">
                <CardContent className="pt-6">
                  ...
                  <ul className="list-disc list-inside space-y-3 text-lg text-foreground ml-4 mb-6">
                    ...
                    <li><strong>Dissecção Linfonodal:</strong>Dissecção Linfonodal: Remoção de todos os gânglios linfáticos de uma região específica, realizada quando há evidência de envolvimento linfonodal, sendo o tratamento padrão para a componente loco regional do Estágio III, porém devido a novos estudos e tecnologias, atualmente, felizmente, houve uma redução significativa do uso dessas cirurgias radicais.</li>
